...
export function validateContext(ctx: Unconstrained): ctx is Context {
  ...
  return (
    ...
    typeof c.p === "number" &&
    (c.p | 0) === c.p &&
    typeof c.array === "number" &&
    (c.array | 0) === c.array &&
    typeof c.bigint === "number" &&
    (c.bigint | 0) === c.bigint &&
    typeof c.boolean === "number" &&
    (c.boolean | 0) === c.boolean &&
    typeof c.float === "number" &&
    (c.float | 0) === c.float &&
    typeof c.int === "number" &&
    (c.int | 0) === c.int &&
    typeof c.nan === "number" &&
    (c.nan | 0) === c.nan &&
    typeof c.null === "number" &&
    (c.null | 0) === c.null &&
    typeof c.object === "number" &&
    (c.object | 0) === c.object &&
    typeof c.string === "number" &&
    (c.string | 0) === c.string &&
    typeof c.undefined === "number" &&
    (c.undefined | 0) === c.undefined
  );
}
