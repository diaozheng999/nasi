 ...
 */
export type ArgumentType<T> = T extends ((arg0: infer U) => Unconstrained) ? U
  : T extends ((...args: infer Us) => Unconstrained) ? Us
  : never;

export type ArgumentTupleType<T> = T extends (...args: infer U) => Unconstrained
  ? U
  : never;
 ...
 */
export type ReturnType<T> = T extends (() => infer R) ? R
  : T extends ((...args: Unconstrained[]) => infer Rt) ? Rt
  : never;
 ...
 */
export type Awaited<T> = T extends undefined ? T
